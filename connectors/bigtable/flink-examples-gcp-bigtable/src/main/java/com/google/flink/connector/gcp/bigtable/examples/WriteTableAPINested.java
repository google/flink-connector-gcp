 ...
 * Bigtable using the Bigtable connector, nested rows and the Table API.
 *
 ...
 * </pre>
 */
public class WriteTableAPINested {
    public static void main(String[] args) throws Exception {
        ...
        String jobName = parameterTool.get("jobName", "Streaming Bigtable Write Table API Nested");
        ...
        Schema schemaDatagen =
                Schema.newBuilder()
                        ...
                        .column(
                                "family1",
                                DataTypes.ROW(
                                        DataTypes.FIELD("stringColumn", DataTypes.STRING()),
                                        DataTypes.FIELD("intColumn", DataTypes.INT())))
                        .column(
                                "family2",
                                DataTypes.ROW(DataTypes.FIELD("stringColumn2", DataTypes.STRING())))
                        .build();
        ...
        tableEnv.createTemporaryTable(
                ...
                TableDescriptor.forConnector("bigtable")
                        ...
                        .option(BigtableConnectorOptions.USE_NESTED_ROWS_MODE, true)
                        .build());
